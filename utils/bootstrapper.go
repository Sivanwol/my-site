...
func (b *Bootstrapper) SetupViews(viewsDir string) {
	b.RegisterView(iris.HTML(viewsDir, ".html").Layout("layouts/main.html"))
}
...
func (b *Bootstrapper) SetupErrorHandlers() {
	b.OnAnyErrorCode(func(ctx iris.Context) {
		...
		if err := ctx.View("layouts/error.html"); err != nil {
...
func (b *Bootstrapper) Bootstrap() *Bootstrapper {
	...
	b.Use(recover.New())
	b.Use(logger.New())
	//b.Configure(iris.WithConfiguration(cnf["server"]))
